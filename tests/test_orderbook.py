...
class TestOrderBook(unittest.TestCase):
    ...
    def test_add_ask(self):
        print("\n BEFORE")
        self.order_book.pprint()
        min_bid_key, min_bid = self.order_book.bids.min_item()
        max_bid_key, max_bid = self.order_book.bids.max_item()
        self.assertEqual(self.order_book.bids.count, 4)
        self.assertEqual(self.order_book.asks.count, 0)
        ...
        self.order_book.add_order(self.create_ask(99, 8), random_str())
        print("\n AFTER")
        self.order_book.pprint()
